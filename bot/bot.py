...
🎨 Создавайте изображения на основе текстовых подсказок в <b>👩‍🎨 Artist</b> /режиме
👥 Добавьте бота <b>чат группы</b>: /help_group_chat
...
Сделайте его <b>администратором</b>, чтобы он мог видеть сообщения (все остальные права могут быть ограничены)
Вы просто молодец!
